     ...
     <div class="project-title">管理&nbsp;>&nbsp;<span style="color: #f1b954">项目详情</span></div>
        <div class="project-tab">
          <el-tabs v-model="activeName">
            ...
            <el-tab-pane label="项目资料" name="projectInformation"></el-tab-pane>
            <el-tab-pane label="租约信息" :name="ProjectInfo.assetType==1?'LeaseInfoFocus':'LeaseInfoDisperse'"></el-tab-pane>
